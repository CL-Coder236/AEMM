...
def get_all_datasets(args: Namespace) -> ContinualDataset:
    ...
    dataset_names = ['seq-cifar10-224', 'seq-cifar100-224','seq-tinyimg', 'seq-imagenet-r', 'seq-cropdisease', 'seq-cub200', 'seq-resisc45']
    # dataset_names = ['seq-tinyimg',  'seq-cropdisease',  'seq-resisc45']
